...
<body style="background-color:#FDF8F5">
    <div class="global-page shadow-color-green">
        <div class="grand-titre">
            <h1 class="text-colorization">Qui suis-je ?</h1>
        ...
        <div class="gp-accueil-section">
            <div style="flex:2;min-width:250px;">
                <p>Je m’appelle Céline et depuis aussi longtemps que je m’en souvienne, j’ai toujours été passionnée par les animaux. </p>
        ...
        <div class="grand-titre">
            <h1 class="text-colorization">Pourquoi choisir un pet sitter professionnel ? </h1>
            <!--<div class="grand-titre-left"></div>
            <div class="grand-titre-right"></div>-->
        </div>
